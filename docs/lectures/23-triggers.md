# Лекція 23. Тригери (Triggers) у PostgreSQL

*Функції (Лекція 21) і процедури (Лекція 22) виконуються, коли їх
...
повертає тип `TRIGGER` (а не звичайний тип, як у Лекції 21), і самого
...
- Тригер автоматизує реакцію на зміну таблиці — на відміну від функцій
  і процедур (Лекції 21-22), його ніхто явно не викликає, він
  спрацьовує сам.
