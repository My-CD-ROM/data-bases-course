...
- Розділ 8 ("Ізоляція транзакцій", с. 63) — прямо до позиції 23. Курс
  ...
  згадуються в [Лекції 14](../lectures/14-acid.md) (ACID, властивість
  Isolation) і [Лекції 19](../lectures/19-postgres-intro.md); ця
...
допоміжної літератури курсу і на [Лекцію 20](../lectures/20-views.md) та
[Практику 18](../practice/18-views.md).

## 19. Views і Materialized Views у PostgreSQL (до заняття № 34 [→ Лекція 20, заняття 36], 3 год)
...
## 20. Реалізація функцій у PostgreSQL (до заняття № 36 [→ Лекція 21, заняття 38], 3 год)
...
## 21. Реалізація процедур у PostgreSQL (до заняття № 38 [→ Лекція 22, заняття 40], 3 год)

**Ваше завдання.** Напишіть процедуру, що виконує на вашій схемі
атомарну пару дій із внутрішнім `COMMIT` — за зразком практичного
шаблону з [Лекції 22](../lectures/22-procedures.md) (наприклад,
...
## 22. Створення тригерів у PostgreSQL (до заняття № 40 [→ Лекція 23, заняття 42], 3 год)
...
окремої лекції курсу (найближча за темою — Лекція 14, ACID, де
