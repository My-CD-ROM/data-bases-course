...
Сім позицій цього модуля супроводжують Лекції 8–15: від об'єднання
...
викладені в самій [Лекції 14](../lectures/14-acid.md) і
[Лекції 15](../lectures/15-transactions.md) курсу; додатково можна
...
- Завжди пишіть явну умову `ON`, ніколи не покладайтесь на старий
  ...
  (див. [Лекція 8](../lectures/08-joins.md)).
...
## 13. Принципи ACID, приклади транзакцій (банкомат, онлайн-магазин) (до заняття № 23 [→ Лекція 14, заняття 25], 3 год)
...
## 14. Транзакції в SQLite: BEGIN, COMMIT, ROLLBACK (до заняття № 24 [→ Лекція 15, заняття 26], 3 год)
